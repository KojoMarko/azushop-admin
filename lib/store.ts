  ...
  persist(
    (set, get) => ({
      ...
      addProduct: (product) => {
        ...
        // Check if new product has low inventory
      ...
      updateProduct: (id, updatedFields) => {
        ...
        // Check if updated product has low inventory
        get().checkLowInventory()
      },
      ...
      deleteProduct: (id) => {
        set((state) => ({
          ...
          // Also remove any inventory alerts for this product
      ...
      deleteCategory: (id) => {
        // First check if there are any subcategories or products using this category
      ...
      updateInventory: (productId, quantity) => {
        ...
        // Check if updated inventory is low
        get().checkLowInventory()
      },
      ...
      checkLowInventory: () => {
        ...
        const lowInventoryProducts = products.filter((product) => product.inventory <= LOW_INVENTORY_THRESHOLD)

        // Create alerts for products that don't already have one
        ...
        const updatedAlerts = inventoryAlerts
          .map((alert) => {
            ...
            if (product.inventory > LOW_INVENTORY_THRESHOLD) {
              return null // Inventory is now above threshold
            }
      ...
      deleteUser: (id) => {
        set((state) => ({
          ...
          // Also remove any activity logs for this user
